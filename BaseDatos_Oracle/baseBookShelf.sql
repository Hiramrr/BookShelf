--------------------------------------------------------
-- Archivo creado  - martes-mayo-27-2025   
--------------------------------------------------------
DROP TYPE "BIBLIOTECA"."CATEGORIA_T";
DROP TYPE "BIBLIOTECA"."CATEGORIA_TAB_T";
DROP TYPE "BIBLIOTECA"."LIBRO_T";
DROP TYPE "BIBLIOTECA"."PRESTAMO_T";
DROP TYPE "BIBLIOTECA"."RESEÑA_T";
DROP TYPE "BIBLIOTECA"."USUARIO_T";
DROP TABLE "BIBLIOTECA"."CATEGORIAS_TABLA" cascade constraints;
DROP TABLE "BIBLIOTECA"."LIBROS" cascade constraints;
DROP TABLE "BIBLIOTECA"."PRESTAMOS" cascade constraints;
DROP TABLE "BIBLIOTECA"."RESEÑAS" cascade constraints;
DROP TABLE "BIBLIOTECA"."USUARIO" cascade constraints;
DROP TABLE "BIBLIOTECA"."USUARIOS" cascade constraints;
DROP VIEW "BIBLIOTECA"."TODOSLIBROS";
DROP PROCEDURE "BIBLIOTECA"."OBTENER_CATEGORIAS_LIBRO";
--------------------------------------------------------
