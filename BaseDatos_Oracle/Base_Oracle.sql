...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BIBLIOTECA"."PRESTAMO_T" AS OBJECT (id int, fecha_solicitud date, fecha_recogida date, estado varchar(50), usuario REF Usuario_t, libro REF Libro_t);
...
Insert into BIBLIOTECA.LIBROS (ID,TITULO,AUTOR,EDITORIAL,NUM_COPIAS,SINOPSIS,CATEGORIAS) values (103,'Oracle','Miyu Maldonado','Coco',5,'Este libro es una introduccion a Oracle',BIBLIOTECA.CATEGORIA_TAB_T(BIBLIOTECA.CATEGORIA_T('Drama'), BIBLIOTECA.CATEGORIA_T('Educativo')));
...
Insert into BIBLIOTECA.TODOSLIBROS (ID,TITULO,AUTOR,EDITORIAL,NUM_COPIAS,SINOPSIS,CATEGORIAS) values (103,'Oracle','Miyu Maldonado','Coco',5,'Este libro es una introduccion a Oracle','Drama, Educativo');
...
CREATE UNIQUE INDEX "BIBLIOTECA"."SYS_C008445" ON "BIBLIOTECA"."PRESTAMOS" ("SYS_NC_OID$")
    PCTFREE 10 INITRANS 2 MAXTRANS 255
  TABLESPACE "USERS" ;
--------------------------------------------------------
